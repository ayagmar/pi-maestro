...
export function buildSupervisorBriefing(
  ...
  return [
    ...
    [
      ...
      "",
      "## Decision rules",
      "- `maestro_drive` action=start already reports the settled outcome; only use inspect when you did not start the drive yourself or the user asks for current state. Never read `.pi/maestro` internals or write ad-hoc inspection scripts.",
