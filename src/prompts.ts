...
export function buildSupervisorBriefing(
  ...
  return [
    ...
    [
      ...
      "",
      "## Decision rules",
      "- Use `maestro_drive` inspect for bounded board state and review evidence: failure kind/message, reviewer roles/verdicts, convergence, notes, and attempt/launch counts. It is sufficient; never read `.pi/maestro` internals or write ad-hoc inspection scripts.",
